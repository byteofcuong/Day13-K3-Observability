...
| Nguyễn Hoàng Việt | Chủ trì CP3; điều tra Metrics → Traces → Logs; fix và preventive measure | [commit 55e10dc](https://github.com/viett207/Day13-K3-Observability/commit/55e10dc34fa454c65871d6d4b51c175d68407667) | Correlation ID nối trace với log; phải dùng ngưỡng 2000ms và lọc `feature=refund` của challenge. |
